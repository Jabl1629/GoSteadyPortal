...
| 2026-07-18 (prod) | **Re-entry + confirmation SMS + user-agreement acknowledgment deployed to prod** (Prod-Api + `app.gosteady.co`); care-circle Lambda health-checked (empty-roster 200 post confirmation-SMS change). Shipped alongside QR re-login ([`d2c-qr-relogin.md`](d2c-qr-relogin.md)). |
