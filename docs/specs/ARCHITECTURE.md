...
| 2A-RD | Patient Read Endpoints | [`phase-2a-read.md`](phase-2a-read.md) | ✅ Deployed (dev) 2026-05-23 — 5 GET routes; tenancy + scope; family_viewer 404-leak prevention; cursor pagination; range cap 30d; audit on success. Smoke 23/23 PASS + real-data validated against `pt_bench_98` + PII scrub clean |
