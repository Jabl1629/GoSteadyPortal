...
Mirror of patient-mgmt + patient-api versions.
"""
...
def _install_stub() -> None:
    ...
    class _NoopLogger:
        ...
        # Powertools' Logger has an `inject_lambda_context` decorator that
        # behavioral-detector applies to its handler. Stub it as a pass-through.
